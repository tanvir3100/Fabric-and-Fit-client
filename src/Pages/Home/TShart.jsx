            ...
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5'>
                {
                    tShirts.map(tShirt => <div key={tShirt._id} className="card bg-base-100 relative group rounded-none">
                        ...
                        <div className='bg-cyan-600 p-2 absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity w-full h-10 md:top-[72.5%] lg:top-[68.5%]'>
